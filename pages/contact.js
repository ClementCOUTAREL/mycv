            ...
            <div className="contact-container">
                ...
                >
                    <div className="form-group">
                        ...
                        {error && errorMessages.name !== "" ? <p className="error">{errorMessages.name}</p> : null}
                    </div>
                    <div className="form-group">
                        <label htmlFor="email">{data.email} :</label>
                        <input type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} />
                        {error && errorMessages.email !== "" ? <p className="error">{errorMessages.email}</p> : null}
                    </div>
                    <div className="form-group">
                        ...
                        {error && errorMessages.message !== "" ? <p className="error">{errorMessages.message}</p> : null}
                    </div>
